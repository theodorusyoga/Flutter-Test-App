...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    ...
    final _contents = [Points(), Menu(), Explore(), Explore(), Explore()];

    final double _screenHeight = MediaQuery.of(context).size.height - MediaQuery.of(context).padding.bottom;
    final double _contentsHeight =
        _screenHeight - _headerHeight - 56; // 56 is CupertinoTabBar's default height + padding
